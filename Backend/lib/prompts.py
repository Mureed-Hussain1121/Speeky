...
that back WEC-US-08..12. Everything the backend feeds to lib.llm_client lives here so
...
# ===========================================================================
# Conversation practice (US-003 / GAP-01 / GAP-03) — ported verbatim
# ===========================================================================
...
def build_system_prompt(topic_key: str, custom_topic: Optional[str] = None, level: str = "intermediate") -> str:
    if custom_topic:
